  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between gap-3">
        <PageIntro
          title="New customer"
          description="Create an internal customer master record for customer booking and receivable control. Customer code is generated by the backend."
        />
      ...
      <Card>
        <CardHeader
          title="Customer form"
          description="Address is required and customer code is not entered manually. Backend validation remains authoritative for uniqueness checks."
        />
