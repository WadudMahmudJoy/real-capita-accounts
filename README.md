...
- Phase 2G Project/Cost-Center Financial Reporting is in progress. Phase 2G Chunk 2G-1 Project Ledger, Chunk 2G-2 Project Cost Report, and Chunk 2G-3 Cost Center Summary are implemented. The Project Cost Report summarizes project-tagged posted voucher lines by cost center, account class, account group, and ledger. Expense and Asset/project-cost totals are labeled separately. The Cost Center Summary summarizes posted project-tagged VoucherLine records by cost center. No schema/migration/report table/new role added. Phase 2G Chunk 2G-4 (Project Financial Summary) and the optional Report E remain locked.
- Still not implemented: Project Financial Summary, Project Cash/Bank Movement View, PDF/Excel export, dashboard analytics, payroll, salary sheets, parties/customers/vendors, file uploads, reversal/correction features, approval workflow, and extra roles beyond Accountant.
