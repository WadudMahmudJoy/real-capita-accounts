...
Phase 2F Accounting Report + Accountant UX Refinement requirement lock is complete and accepted. It locks six issues: Balance Sheet current P/L inclusion, report/table layout readability, voucher line dynamic field visibility, report filter UX clarity, dropdown/table text clipping, and demo data cleanliness planning. See `docs/requirements/phase-2f-accounting-report-ux-refinement-requirement-lock.md`, `docs/acceptance/phase-2f-acceptance-criteria.md`, and `docs/plans/phase-2f-accounting-report-ux-refinement-plan.md`.
