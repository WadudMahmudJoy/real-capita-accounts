...
Phase 2D accounting reports requirement documentation/specification lock is complete. Chunk 2D-2 implements backend report APIs for General Ledger, Cash Book, and Bank Book only. Trial Balance, financial statements, project/cost-center summaries, report frontend pages, and exports are not implemented.
