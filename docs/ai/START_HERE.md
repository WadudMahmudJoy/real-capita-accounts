...
Phase 2G Project/Cost-Center Financial Reporting is in progress. Phase 2G Chunk 2G-1 Project Ledger, Chunk 2G-2 Project Cost Report, and Chunk 2G-3 Cost Center Summary are implemented. The Project Cost Report summarizes project-tagged posted voucher lines by cost center, account class, account group, and ledger. Expense and Asset/project-cost totals are labeled separately. Phase 2G Chunk 2G-3 Cost Center Summary is implemented: `GET /reports/cost-center-summary` and `/app/reports/cost-center-summary`. The report summarizes posted project-tagged VoucherLine records by cost center. Lines without cost center appear as Unassigned only when they exist. No double counting. No schema/migration/report table/new role. Drill-down links to Project Ledger. Phase 2G Chunk 2G-4 (Project Financial Summary) remains locked.
