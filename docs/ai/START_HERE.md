...
Phase 2K Voucher Fund-Line Project Tagging requirement lock is complete. It defines optional project and cost center tagging on Cash, Bank, and MFS voucher lines so those lines can be tracked in the Project Fund Movement View. Implemented chunks: 2K-1 requirement lock. See `docs/requirements/phase-2k-voucher-fund-line-project-tagging-requirement-lock.md`, `docs/acceptance/phase-2k-acceptance-criteria.md`, and `docs/plans/phase-2k-voucher-fund-line-project-tagging-plan.md`.
