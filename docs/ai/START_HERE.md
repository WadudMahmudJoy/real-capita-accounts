...
If continuing after Codex limit in Droid CLI, GLM, DeepSeek, Opus, Gemini, or another tool, read `docs/plans/phase-2e-mfs-bkash-support-implementation-plan.md` and `docs/requirements/phase-2e-mfs-bkash-support-requirement-lock.md` before coding. The next recommended task is Phase 2E Chunk 2E-7 final integration and acceptance review, unless review finds issues; do not start MFS voucher posting support before that chunk is confirmed.
